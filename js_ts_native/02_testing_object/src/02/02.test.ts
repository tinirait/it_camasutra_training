...
beforeEach(() => {
    city = {
        title: "NewYork",
        houses: [{builderAt:2012, repaired:false, address:{number:100,street:{title:"White street"}}},
                 {builderAt:2008, repaired:false, address:{number:100,street:{title:"Happy street"}}},
                 {builderAt:2020, repaired:false, address:{number:101,street:{title:"Happy street"}}}
            ],
        governmentBuildings: [
